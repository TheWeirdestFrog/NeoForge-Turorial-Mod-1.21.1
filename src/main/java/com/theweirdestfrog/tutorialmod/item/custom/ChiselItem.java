package com.theweirdestfrog.tutorialmod.item.custom;
...
public class ChiselItem extends Item {
    private static final Map<Block, Block> CHISEL_MAP =
            Map.of(
                    ...
                    ModBlocks.TIN_BLOCK.get(), ModBlocks.RAW_TIN_BLOCK.get()
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        ...
        if(Screen.hasShiftDown()) {
            tooltipComponents.add(Component.translatable("tooltip.tutorialmod.chisel_item.shift_down"));
        } else {
            tooltipComponents.add(Component.translatable("tooltip.tutorialmod.chisel_item_.shift_up"));
        }
